...
<!-- badges: start -->
[![Codecov test coverage](https://codecov.io/gh/atsyplenkov/loadflux/branch/master/graph/badge.svg)](https://codecov.io/gh/atsyplenkov/loadflux?branch=master)
<!-- badges: end -->

The `loadflux` package is aimed at comprehensive analysis of the intra-event suspended sediment dynamics.
